              ...
              <div className="glassmorphism p-10 rounded-[32px] space-y-10 border border-white/10 shadow-2xl">
                ...
                <div className="pt-10 border-t border-white/10 space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-4">
                      <label className="text-[10px] uppercase tracking-[0.2em] opacity-50 font-bold block">DeepSeek API Key</label>
                      <div className="relative">
                        <input 
                          type="password" 
                      ...
                      <p className="text-[10px] text-text/40 italic">Enter your DeepSeek API key to power Lyra AI.</p>
                    </div>
                  </div>
                </div>
